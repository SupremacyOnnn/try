...
const Cards = ({ data }) => {
  return (
    ...
    // </div>
    <div
      className="max-w-sm mt-4 mx-auto bg-white rounded-xl shadow-md overflow-hidden"
      onMouseOver={() => (document.body.style.cursor = "pointer")}
      onMouseOut={() => (document.body.style.cursor = "default")}
    >
      <div className="sm:flex">
        <div className="sm:flex-shrink-0">
          <img
            className="h-20 w-full object-cover w-20 "
            src="data:image/png;base64,"
            alt="Card image"
          />
        </div>
        <div className="p-4">
          <div className="uppercase tracking-wide text-md text-black font-semibold">
            {data.name}
          </div>
